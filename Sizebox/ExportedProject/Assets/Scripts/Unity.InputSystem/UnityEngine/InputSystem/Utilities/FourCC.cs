...
namespace UnityEngine.InputSystem.Utilities
{
	public struct FourCC : IEquatable<FourCC>
	{
		...
		{
			return string.Format("{0}{1}{2}{3}", (char)(m_Code >> 24), (char)((m_Code & 0xFF0000) >> 16), (char)((m_Code & 0xFF00) >> 8), (char)((uint)m_Code & 0xFFu));
		}
		...
		public override bool Equals(object obj)
		{
			...
			object obj2;
			if ((obj2 = obj) is FourCC)
			{
				FourCC other = (FourCC)obj2;
				return Equals(other);
			}
			return false;
		}
