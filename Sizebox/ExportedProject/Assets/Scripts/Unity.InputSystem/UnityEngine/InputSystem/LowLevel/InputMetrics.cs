...
namespace UnityEngine.InputSystem.LowLevel
{
	...
	public struct InputMetrics
	{
		...
		public float averageEventBytesPerFrame
		{
			get
			{
				return (float)totalEventBytes / (float)totalUpdateCount;
			}
		}
		...
		public double averageProcessingTimePerEvent
		{
			get
			{
				return totalEventProcessingTime / (double)totalEventCount;
			}
		}
		...
		public double averageLagTimePerEvent
		{
			get
			{
				return totalEventLagTime / (double)totalEventCount;
			}
		}
	}
}
