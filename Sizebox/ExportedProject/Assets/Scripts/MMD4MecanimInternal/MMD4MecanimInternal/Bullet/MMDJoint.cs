...
namespace MMD4MecanimInternal.Bullet
{
	public class MMDJoint
	{
		...
		private bool _SetupConstraint()
		{
			...
			{
				MMDRigidBody targetRigidBodyA = _targetRigidBodyA;
				MMDRigidBody targetRigidBodyB = _targetRigidBodyB;
				return true;
			}
			...
			_bulletConstraint = new Generic6DofSpringConstraint(bulletRigidBody, bulletRigidBody2, frameInA, frameInB, true);
