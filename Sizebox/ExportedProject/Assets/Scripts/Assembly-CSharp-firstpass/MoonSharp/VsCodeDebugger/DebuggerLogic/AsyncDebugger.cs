...
namespace MoonSharp.VsCodeDebugger.DebuggerLogic
{
	internal class AsyncDebugger : IDebugger
	{
		...
		private sealed class _003C_003Ec__DisplayClass54_0
		{
			...
			internal bool _003CFindSourceByName_003Eb__0(SourceCode s)
			{
				return s.Name.Replace('\\', '/').ToUpperInvariant() == path;
			}
		}
		...
		public SourceCode FindSourceByName(string path)
		{
			...
			_003C_003Ec__DisplayClass54_.path = path;
			_003C_003Ec__DisplayClass54_.path = _003C_003Ec__DisplayClass54_.path.Replace('\\', '/').ToUpperInvariant();
			foreach (KeyValuePair<int, string> item in m_SourcesOverride)
			{
				if (item.Value.Replace('\\', '/').ToUpperInvariant() == _003C_003Ec__DisplayClass54_.path)
				{
					return m_SourcesMap[item.Key];
				}
			}
			return m_SourcesMap.Values.FirstOrDefault(_003C_003Ec__DisplayClass54_._003CFindSourceByName_003Eb__0);
		}
