...
public class JiggleBone : MonoBehaviour
{
	...
	private Vector3 virtualDynamicPos;
	...
	private Vector3 dynamicPos
	{
		get
		{
			return virtualDynamicPos.ToWorld();
		}
		set
		{
			virtualDynamicPos = value.ToVirtual();
		}
	}
	...
	public float targetDistance
	{
		get
		{
			return unscaledTargetDistance * base.transform.lossyScale.y;
		}
	}
