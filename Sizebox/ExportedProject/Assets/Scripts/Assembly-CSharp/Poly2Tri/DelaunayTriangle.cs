...
namespace Poly2Tri
{
	public class DelaunayTriangle
	{
		...
		public void ClearNeighbors()
		{
			...
			DelaunayTriangle delaunayTriangle2 = (Neighbors[2] = null);
			DelaunayTriangle value = (neighbors2[1] = delaunayTriangle2);
			neighbors[0] = value;
		}
		...
		public void Clear()
		{
			...
			TriangulationPoint triangulationPoint2 = (Points[2] = null);
			TriangulationPoint value = (points2[1] = triangulationPoint2);
			points[0] = value;
		}
