...
public abstract class Motor : MonoBehaviour
{
	...
	public virtual void FixedUpdate()
	{
		...
		boost = Mathf.Clamp(boosting ? (boost - boostBurnRate * Time.timeScale * 0.05f * TimeMaster.inverseFixedTimeFactor) : boost, 0f, maxBoost);
		boostPrev = boosting;
		bool num;
	...
	public virtual void Update()
	{
		...
		if ((bool)smoke)
		{
			...
			emission.rateOverTime = new ParticleSystem.MinMaxCurve((health < 0.7f) ? (initialSmokeEmission * (1f - health)) : 0f);
		}
	}
}
