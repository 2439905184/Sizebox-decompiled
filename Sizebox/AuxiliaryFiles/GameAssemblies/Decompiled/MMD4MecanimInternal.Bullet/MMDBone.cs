...
public class MMDBone
{
	...
	public bool isBoneTranslate => (_pmxBoneFlags & PMXBoneFlag.Translate) != 0;

	public bool isTransformAfterPhysics => (_pmxBoneFlags & PMXBoneFlag.TransformAfterPhysics) != 0;
