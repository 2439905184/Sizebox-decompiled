...
public class BinaryReader
{
	...
	public int currentStructFourCC => _currentStructFourCC;

	public int currentStructFlags => _currentStructFlags;

	public int currentStructLength => _currentStructLength;

	public int currentStructIndex => _currentStructIndex;
